...
//
//
//  Created by Ely on 16/6/1.
//  Copyright © 2016年 yimouleng. All rights reserved.
//
...
extension UIView {
    ...
    */
    public func AlignHorizontal(type type: AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint] {
        ...
        return
            AlignLayout(referView, attributes: type.layoutAttributes(false, isVertical: false), size: size, offset: offset)
    }
